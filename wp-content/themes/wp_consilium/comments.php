...
<div id="comments" class="comments-area">
	...
	$args = array(
			...
			'comment_field' =>  '<p class="comment-form-comment"><textarea id="comment" name="comment" cols="45" rows="8" placeholder="'.__('Write your comment here.',THEMENAME).'" aria-required="true">' .
			'</textarea></p>',
			...
			'fields' => apply_filters( 'comment_form_default_fields', array(
					...
					'" size="30"' . $aria_req . ' placeholder="'.__('Your full name',THEMENAME).'"/></p>',

					'email' =>
					'<p class="comment-form-email col-xs-12 col-sm-4 col-md-4 col-lg-4">'.
					'<input id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) .
					'" size="30"' . $aria_req . ' placeholder="'.__('E-mail address',THEMENAME).'"/></p>',
